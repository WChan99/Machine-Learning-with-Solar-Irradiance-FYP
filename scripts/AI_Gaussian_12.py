# Gaussian processing regression (12 month prediction (use of daily))
import pandas as pd
import numpy as np
...
for m in range(1,13):
    ...
    for i in range(13):
        ...
        for k in range(0, 6, 1):
            ...
            a+=1
            # Sum up the predictions for each 10-minute interval
            hourly_prediction = np.sum(y_pred)
            
        #Append for 8am - 8pm data
        pm_predictions.append(hourly_prediction)
